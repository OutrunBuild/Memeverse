...
/**
 * @dev EIP-712 variant for minimal proxy (Init) contracts: the domain data lives in ERC-7201 storage
 * populated during initialization instead of constructor-set immutables.
 *
