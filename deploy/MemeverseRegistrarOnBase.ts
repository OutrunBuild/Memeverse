...
const contractName = 'MemeverseRegistrar';
...
const deploy: DeployFunction = async (hre) => {
    ...
    const encodedArgs = hre.ethers.utils.defaultAbiCoder.encode(
        ['address', 'address', 'address', 'address', 'address', 'uint128', 'uint128', 'uint32'],
        constructorArgs
    );
...
deploy.tags = ["MemeverseRegistrarOnBase"]
